...
public class TopicConfigManager extends ConfigManager {
     ...
     *
     * @param topic msg对应的topic
     * @param defaultTopic  producer 的默认值为"TBW102"(CreateTopicKey)
     * @param remoteAddress
                ...
                try {
                    ...
                    if (defaultTopicConfig != null) {
                        ...
                        if (PermName.isInherited(defaultTopicConfig.getPerm())) {
                            ...
                            //取producer 客户端 设置的WriteQueueNums  和  broker端默认设置WriteQueueNums 之间的最小值
                            int queueNums =
                    ...
                    //代码走到这里，说明已经新建了topic ，进一步说明该broker的数据版本已改变
                    if (topicConfig != null) {
